...
const keycodes = {
	...
	'KC_PWR': new Keycode('KC_PWR', '关机', []),
	'KC_SLEP': new Keycode('KC_SLEP', '休眠', []),
	'KC_WAKE': new Keycode('KC_WAKE', '唤醒', []),
	'KC_MUTE': new Keycode('KC_MUTE', '静音', []),
	'KC_VOLU': new Keycode('KC_VOLU', '音量+', ['VOLUME UP']),
	'KC_VOLD': new Keycode('KC_VOLD', '音量-', ['VOLUME DOWN']),
	'KC_MNXT': new Keycode('KC_MNXT', '下一曲', []),
	'KC_MPRV': new Keycode('KC_MPRV', '上一曲', ['PREVIOUS']),
	'KC_MSTP': new Keycode('KC_MSTP', '停止', []),
	'KC_MPLY': new Keycode('KC_MPLY', '播放', []),
	'KC_MSEL': new Keycode('KC_MSEL', '播放器', ['SELECT']),
	'KC_MAIL': new Keycode('KC_MAIL', '邮件', []),
	'KC_CALC': new Keycode('KC_CALC', '计算器', ['CALCULATOR']),
	'KC_MYCM': new Keycode('KC_MYCM', '我的电脑', ['MY COMPUTER']),
	...
	'BL_DEC': new Keycode('BL_DEC', '亮度减', []),
	'BL_INC': new Keycode('BL_INC', '亮度加', []),
	'BL_TOGG': new Keycode('BL_TOGG', '开关灯', []),
	'BL_STEP': new Keycode('BL_STEP', '亮度循环', []),
	'BL_BRTG': new Keycode('BL_BRTG', '呼吸灯', []),
	'RGB_TOG': new Keycode('RGB_TOG', 'RGB开关', []),
	'RGB_MOD': new Keycode('RGB_MOD', 'RGB模式', []),
	'RGB_HUI': new Keycode('RGB_HUI', 'RGB色相减', []),
	'RGB_HUD': new Keycode('RGB_HUD', 'RGB色相加', []),
	'RGB_SAI': new Keycode('RGB_SAI', 'RGB饱和减', []),
	'RGB_SAD': new Keycode('RGB_SAD', 'RGB饱和加', []),
	'RGB_VAI': new Keycode('RGB_VAI', 'RGB亮度减', []),
	'RGB_VAD': new Keycode('RGB_VAD', 'RGB亮度加', []),
	'RGB_SPI': new Keycode('RGB_SPI', 'RGB加速', []),
	'RGB_SPD': new Keycode('RGB_SPD', 'RGB减速', []),
	'RGB_M_P ':new Keycode('RGB_M_P', 'RGB静态', []),
	'RGB_M_R ':new Keycode('RGB_M_R', 'RGB彩虹', []),
	'RGB_M_B ':new Keycode('RGB_M_B', 'RGB呼吸', []),
...
const categories = {
	...
	'灯光': [
		'BL_TOGG', 'BL_DEC', 'BL_INC', 'BL_STEP', 'BL_BRTG','',
