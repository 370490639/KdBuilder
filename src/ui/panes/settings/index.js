...
class Settings extends React.Component {
	...
	render() {
		...
		return <div className='pane-settings'>
			...
			<h2 style={{ width: '8rem', marginRight: '0.8rem' }}>配列名称</h2>
			<input
				style={{ width: '8rem' }}
				type='text'
			...
			<div style={{ height: '0.5rem' }}/>
			<h2 style={{ width: '8rem', marginRight: '0.8rem' }}>填写空码</h2>
			<input
				style={{ width: '8rem' }}
				type='text'
			...
			<div style={{ height: '0.5rem' }}/>
			<h2 style={{ width: '8rem', marginRight: '0.8rem' }}>Bootloader 大小</h2>
			<select
				style={{ width: '8rem' }}
				value={ keyboard.settings.bootloaderSize }
				onChange={ e => keyboard.setSetting('bootloader 大小', parseInt(e.target.value)) }>
			...
			<div style={{ height: '0.5rem' }}/>
			<h2 style={{ width: '8rem', marginRight: '0.8rem' }}>RGB灯数量</h2>
			...
			<div style={{ height: '0.5rem' }}/>
			<h2 style={{ width: '8rem', marginRight: '0.8rem' }}>背光等级</h2>
			<div style={{ width: '8rem', display: 'inline-block', textAlign: 'left' }}>
				<NumberBox
					style={{ width: '3.5rem' }}
					min='0'
